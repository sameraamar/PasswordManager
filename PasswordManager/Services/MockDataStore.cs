...
namespace PasswordManager.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            items = new List<Item>()
            {
                new Item { Id = Guid.NewGuid().ToString(), Text = "www.google.com", Password= "click to edit." },
                new Item { Id = Guid.NewGuid().ToString(), Text = "appleid.apple.com", Password="click to edit." },
